...
%This function was generated by loadlibrary.m parser version  on Wed Nov 19 13:06:43 2014
%perl options:'ps6000Wrap.i -outfile=ps6000WrapMFile.m -thunkfile=ps6000Wrap_thunk_glnxa64.c -header=ps6000Wrap.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps6000Wrap_thunk_glnxa64');
% extern int16_t RunBlock ( int16_t handle , uint32_t preTriggerSamples , uint32_t postTriggerSamples , uint32_t timebase , int16_t oversample , uint32_t segmentIndex ); 
...
% extern void clearStreamingParameters ( int16_t handle ); 
